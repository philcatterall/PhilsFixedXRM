...
interface Window {
    Xrm: Xrm.XrmStatic;
    GetGlobalContext(): Xrm.Context;// Type definitions for Microsoft Dynamics xRM API 9.0
    ...
    declare namespace Xrm {
        ...
        namespace Events {
            ...
            interface ProcessStatusChangedEventArguments {
                ...
                // getStatus(): ProcessFlow.ProcessStatus; // PhilC - old code
            ...
            interface EventContext {
                 ...
                 */
                getEventSource(): Attributes.Attribute | Controls.Control | Entity | Controls.Tab; //Philc Added
